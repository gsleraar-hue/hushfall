...
(function () {
  ...
  const LIST = [
    G('regen-zacht', 'Zachte regen', 'regen', 'Motregen op het raam, eindeloos', rain, { intensity: 0.3 }, 0.95, 0.1),
    G('regen-stevig', 'Stevige regenbui', 'regen', 'Regen op dak en straat', rain, { intensity: 0.65 }, 0.61, 0.1),
    G('regen-stortbui', 'Stortbui', 'regen', 'Zware regen met gerommel', rain, { intensity: 0.95 }, 0.4, 0.1),
    G('onweer-afstand', 'Onweer op afstand', 'onweer', 'Regen met verre donder', thunder, { rainIntensity: 0.5 }, 0.64, 0.14),
    G('onweer-dichtbij', 'Onweer boven het huis', 'onweer', 'Zware bui met knallen', thunder, { rainIntensity: 0.85 }, 0.52, 0.12),
    G('wind-bomen', 'Wind door de bomen', 'wind', 'Ruisende bladeren, vlagen', wind, { strength: 0.5, trees: true }, 2.4, 0.08),
    G('wind-storm', 'Stormwind', 'wind', 'Huilende wind om het huis', wind, { strength: 0.9, trees: false }, 0.96, 0.06),
    G('wind-bries', 'Zachte bries', 'wind', 'Nauwelijks meer dan adem', wind, { strength: 0.2, trees: true }, 2.14, 0.1),
    G('zee-strand', 'Golven op het strand', 'zee', 'Rustige branding', waves, { size: 0.5 }, 0.75, 0.1),
    G('zee-woelig', 'Woelige zee', 'zee', 'Grote golven op de rotsen', waves, { size: 1 }, 0.62, 0.08),
    G('water-beek', 'Bergbeek', 'water', 'Snel stromend, borrelend water', stream, { speed: 0.7 }, 1.9, 0.12),
    G('water-riviertje', 'Kabbelend riviertje', 'water', 'Langzaam en breed', stream, { speed: 0.3 }, 2.1, 0.12),
    G('vuur-haard', 'Knapperend haardvuur', 'vuur', 'Houtvuur met knappen en ploffen', fire, { size: 0.6 }, 1.9, 0.1),
    G('vuur-kampvuur', 'Groot kampvuur', 'vuur', 'Veel vlammen, veel knappen', fire, { size: 1 }, 1.65, 0.08),
    G('vuur-kaarsen', 'Nagloeiende as', 'vuur', 'Zacht gloeiend, af en toe een knap', fire, { size: 0.2 }, 3.56, 0.12),
    G('vogels-ochtend', 'Ochtendvogels', 'vogels', 'Zangvogels in de tuin', birds, { density: 0.7, forest: true }, 3.05, 0.2),
    G('vogels-verspreid', 'Vogels in de verte', 'vogels', 'Af en toe een roep', birds, { density: 0.25, forest: true }, 2.6, 0.22),
    G('nacht-krekels', 'Krekels in de nacht', 'nacht', 'Zomeravond met krekels en een uil', night, { crickets: 0.7, owl: true }, 2.95, 0.18),
    G('nacht-kikkers', 'Kikkers bij de vijver', 'nacht', 'Krekels en kwakende kikkers', night, { crickets: 0.4, frogs: true, owl: false }, 3.55, 0.18),
    G('cafe-rustig', 'Rustig café', 'cafe', 'Zacht geroezemoes, een enkel gesprek, kopjes', cafe, { busy: 0.3 }, 3.79, 0.3),
    G('cafe-druk', 'Druk koffiehuis', 'cafe', 'Volle zaak: pratende mensen, bestek, de machine', cafe, { busy: 0.9 }, 2.95, 0.26),
    G('cafe-gesprekken', 'Tafel vol gesprekken', 'cafe', 'Mensen die om je heen zitten te praten', cafe, { busy: 0.6 }, 3.3, 0.28),
    G('cafe-jazz', 'Café met jazz', 'cafe', 'Geroezemoes met zachte jazz op de achtergrond', cafe, { busy: 0.55, music: true }, 1.32, 0.24),
    G('huis-ventilator', 'Ventilator', 'huis', 'Gelijkmatig zoemen', fan, { speed: 0.5 }, 0.5, 0.05),
    G('huis-klok', 'Tikkende klok', 'huis', 'Een klok in een stille kamer', clock, {}, 2.8, 0.22),
    G('huis-typen', 'Typen op een toetsenbord', 'huis', 'Iemand die geconcentreerd werkt', typing, { speed: 0.6 }, 7, 0.16),
    G('stad-verkeer', 'Verkeer in de verte', 'stad', 'Passerende auto\'s, stadsgeruis', traffic, { density: 0.5 }, 0.67, 0.14),
    G('stad-nacht', 'Stad bij nacht', 'stad', 'Weinig verkeer, veel ruimte', traffic, { density: 0.2 }, 0.73, 0.16),
    G('muziek-avondlicht', 'Avondlicht', 'muziek', 'Warme, zwevende akkoorden in majeur', pads, { scale: 'major', root: 48, warmth: 0.6 }, 1.31, 0),
    G('muziek-nevelbank', 'Nevelbank', 'muziek', 'Trage mineurpads met hoge sprankels', pads, { scale: 'dorian', root: 45, warmth: 0.45 }, 1.58, 0),
    G('muziek-ochtendmist', 'Ochtendmist', 'muziek', 'Lichte, open lydische klanken', pads, { scale: 'lydian', root: 50, warmth: 0.7 }, 1.36, 0),
    G('muziek-diepe-ruimte', 'Diepe ruimte', 'muziek', 'Drone met langzaam ademende filters', pads, { scale: 'minor', root: 38, warmth: 0.3, drone: true, chordLen: [14, 24], voices: 3 }, 0.68, 0),
    G('muziek-schemering', 'Schemering', 'muziek', 'Donkere mineurakkoorden, zonder sprankels', pads, { scale: 'minor', root: 43, warmth: 0.35, sparkle: false, chordLen: [11, 18] }, 0.99, 0),
    G('muziek-winterpiano', 'Winterse piano', 'muziek', 'Spaarzame pianotonen boven een pad', piano, { scale: 'penta', root: 60, tempo: 1 }, 1.18, 0),
    G('muziek-nachtpiano', 'Piano bij nacht', 'muziek', 'Trage mineurtonen met veel galm', piano, { scale: 'mpenta', root: 57, tempo: 0.7 }, 1.32, 0),
    G('jazz-piano', 'Pianojazz', 'jazz', 'Rustige vleugel met bas en bezems, om niet te storen', jazzCombo, { bpm: 84, changes: 'ballade', feel: 'ballad', lead: 'grand', comp: 'grand', leadDensity: 0.55, drumLevel: 0.7 }, 0.73, 0.06),
    G('jazz-pianotrio', 'Pianotrio', 'jazz', 'Swingend trio: vleugel, wandelende bas en ride', jazzCombo, { bpm: 108, changes: 'turnaround', feel: 'swing', lead: 'grand', comp: 'grand' }, 0.58, 0.05),
    G('jazz-coffeetable', 'Coffee table jazz', 'jazz', 'Vibrafoon en zachte akkoorden, nergens opdringerig', jazzCombo, { bpm: 88, changes: 'ballade', feel: 'ballad', lead: 'vibes', comp: 'vibes', drumLevel: 0.5, leadDensity: 0.5 }, 0.5, 0.06),
    G('jazz-sax', 'Saxofoontrio', 'jazz', 'Blazende sax over piano, bas en drums', jazzCombo, { bpm: 112, changes: 'iiVI', feel: 'swing', lead: 'sax', comp: 'piano' }, 0.62, 0.05),
    G('jazz-blues', 'Late-avondblues', 'jazz', 'Twaalf maten blues met sax en orgelachtige piano', jazzCombo, { bpm: 88, changes: 'blues', feel: 'swing', lead: 'sax', comp: 'piano', tape: true }, 0.88, 0.06),
    G('jazz-bossa', 'Bossa nova', 'jazz', 'Nylon gitaar, vibrafoon en zachte tik', jazzCombo, { bpm: 128, changes: 'bossa', feel: 'bossa', lead: 'vibes', comp: 'nylon' }, 0.8, 0.06),
    G('jazz-bossa-mineur', 'Bossa in mineur', 'jazz', 'Warme gitaar, mineurakkoorden, laat op de avond', jazzCombo, { bpm: 120, changes: 'bossaMin', feel: 'bossa', lead: 'nylon', comp: 'nylon', drumLevel: 0.7 }, 0.91, 0.06),
    G('jazz-modaal', 'Modale jazz', 'jazz', 'Twee akkoorden, alle ruimte, sax die af en toe iets zegt', jazzCombo, { bpm: 84, changes: 'modaal', feel: 'swing', lead: 'sax', comp: 'piano', leadDensity: 0.4 }, 0.87, 0.06),
    G('jazz-lofi', 'Lo-fi jazzcafé', 'jazz', 'Elektrische piano, bas en geborstelde drums', lofiJazz, { bpm: 78, drums: true }, 0.9, 0.05),
    G('jazz-nacht', 'Jazz bij nacht', 'jazz', 'Traag, mineur, alleen piano en bas', lofiJazz, { bpm: 62, drums: false, minor: true }, 1.2, 0.06),
    G('jazz-zondag', 'Zondagochtendjazz', 'jazz', 'Vlot en licht, met vinylkraak', lofiJazz, { bpm: 88, drums: true, minor: false }, 0.9, 0.05),
    G('film-strijkers', 'Trage strijkers', 'film', 'Grote strijkersakkoorden die minutenlang blijven hangen', filmscore, { stijl: 'strijkers', modus: 'eolisch', grondtoon: 45, tempo: 0.9 }, 1.03, 0),
    G('film-elegie', 'Elegie', 'film', 'Donkerder, frygisch, met diepe koperzwellingen', filmscore, { stijl: 'strijkers', modus: 'frygisch', grondtoon: 41, tempo: 0.75 }, 1.17, 0),
    G('film-verstilling', 'Verstilling', 'film', 'Bijna alleen een drone en een enkele strijkerslaag', filmscore, { stijl: 'strijkers', modus: 'dorisch', grondtoon: 43, tempo: 0.6, ruis: false }, 1.13, 0),
    G('film-cirkels', 'Cirkels', 'film', 'Een pianomotief dat blijft herhalen en langzaam verandert', filmscore, { stijl: 'postminimal', modus: 'eolisch', grondtoon: 45, tempo: 1 }, 1.2, 0),
    G('film-nachtcirkels', 'Nachtcirkels', 'film', 'Hetzelfde idee, trager en in mineur', filmscore, { stijl: 'postminimal', modus: 'frygisch', grondtoon: 43, tempo: 0.72 }, 1.3, 0),
    G('film-nachtvlucht', 'Nachtvlucht', 'film', 'Brede analoge pads, arpeggio door de echo, zingende lead', filmscore, { stijl: 'analoog', modus: 'eolisch', grondtoon: 45, tempo: 0.95 }, 1.2, 0),
    G('film-horizon', 'Horizon', 'film', 'Lichter en wijder, met een trage filterveeg', filmscore, { stijl: 'analoog', modus: 'lydisch', grondtoon: 47, tempo: 0.85 }, 0.96, 0),
    G('film-vilt', 'Viltpiano', 'film', 'Een piano met vilt tussen de hamers, zo dichtbij dat je het mechaniek hoort', kamermuziek, { modus: 'eolisch', grondtoon: 48, tempo: 1, stratus: 0.35, kwartet: false }, 3.09, 0),
    G('film-cascade', 'Cascade', 'film', 'Viltpiano met kwartet; hoge tonen die vanzelf uit het akkoord vallen', kamermuziek, { modus: 'eolisch', grondtoon: 48, tempo: 1, stratus: 0.7 }, 2.7, 0),
    G('film-eiland', 'Eiland', 'film', 'Lichter en wijder, piano en strijkers die elkaar ruimte geven', kamermuziek, { modus: 'lydisch', grondtoon: 50, tempo: 0.8, stratus: 0.45 }, 2.5, 0),
    G('film-avondlicht', 'Avondlicht', 'film', 'Traag en donkerder, met lange pauzes tussen de frasen', kamermuziek, { modus: 'dorisch', grondtoon: 45, tempo: 0.65, stratus: 0.3 }, 2.65, 0),
    ...
    G('greg-organum', 'Organum', 'gregoriaans', 'Vroege meerstemmigheid: een tweede stem in kwinten', gregoriaans, { modus: 'dorisch', grondtoon: 45, tempo: 0.85, zangers: 4, organum: true, bourdon: true }, 1.29, 0),
    G('greg-hildegard', 'Hildegard von Bingen', 'gregoriaans', 'Hoge vrouwenstemmen, wijde sprongen en lange melismen boven een bourdon', gregoriaans, { modus: 'dorisch', grondtoon: 50, tempo: 0.9, zangers: 4, hoog: true, sprongen: 0.7, bourdon: true }, 1.4, 0),
    G('greg-lydisch', 'Lauden', 'gregoriaans', 'Ochtendgezang in de lichte lydische modus', gregoriaans, { modus: 'lydisch', grondtoon: 48, tempo: 1.05, zangers: 5 }, 6, 0),
    G('greg-kapel', 'Stille kapel', 'gregoriaans', 'Bourdon, verre klok en af en toe een gezongen regel', kapel, { modus: 'frygisch', grondtoon: 45 }, 1.1, 0),
    G('kerst-koor', 'Kerstkoor', 'kerst', 'Vierstemmig koor in een kerk, bekende kerstliederen', kerstkoor, { orgel: true }, 1.05, 0),
    G('kerst-carillon', 'Carillon in de sneeuw', 'kerst', 'Klokkenspel met kerstliederen en zachte wind', carillon, { snow: true }, 1.58, 0),
    G('kerst-slee', 'Arrenslee', 'kerst', 'Sleebellen, hoefslag in de sneeuw en de glijders', sleighRide, { speed: 1 }, 2.6, 0.12),
    G('kerst-sneeuw', 'Wandelen door de sneeuw', 'kerst', 'Knerpende sneeuw, wind en een klok in de verte', snowWalk, { pace: 1, bells: true }, 2.9, 0.14),
    G('kerst-orgel', 'Kerkorgel', 'kerst', 'Kerstliederen op vol register, lange nagalm', churchOrgan, {}, 1.65, 0),
    G('kerst-markt', 'Kerstmarkt', 'kerst', 'Mensen buiten, een draaiorgel en belletjes', kerstmarkt, { busy: 0.7 }, 1.86, 0.1),
    G('kerst-speeldoos', 'Kerstspeeldoos', 'kerst', 'Speeldoos met kerstliederen en belletjes', musicBox, { bells: true, pad: true }, 0.87, 0),
    G('kerst-klokken', 'Kerstklokken in de sneeuw', 'kerst', 'Klokkenspel met winterwind', churchBells, { wind: true }, 0.96, 0),
